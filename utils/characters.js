...
const CHARACTER_COPY = {
  home: [
    ...
    "你不需要马上变好，先让自己别继续被消耗。",
    "如果今天很乱，就先留下一个最具体的事。",
    "Croissant 没有催你。它只是陪你看一眼今天到底发生了什么。",
  ...
  diaryNew: [
    "Elodie 提醒：先别急着解释。只写发生了什么，就已经在把混乱往外挪。",
    "不需要一次写得很完整，先把最清楚的一点留下来。",
    "事实不是为了证明你脆弱，而是为了帮你看清发生了什么。",
    "如果你不知道怎么写，就从“谁、什么时候、说了什么”开始。",
    "先不用判断自己是不是太敏感，先把事情放到纸面上。",
    "你可以只写一点点。记录不是考试。",
    "把感受写下来不是添麻烦，是给自己留一条线索。",
    "今天先整理一件事，不需要整理整个人生。"
  ],
  diaryDetail: [
    "Elodie 帮你把混乱整理成可以回看的线索。",
    "这份纪要不是为了攻击谁，是为了让你别把所有事都吞回去。",
  ...
  diarySavedNegative: [
    "Croissant 收到了这条记录。它不急着替你做决定，只是陪你把事情放到桌面上看清楚。",
    "Croissant 受到了一点磨损。好在这件事已经不只是在身体里打转了。",
    "这不是小题大做。你是在替自己留下线索。",
    "你已经把混乱从身体里拿出来了一点。",
    "今天先到这里也可以。能写下来，本身已经是在保护自己。"
  ],
  diarySavedPositive: [
