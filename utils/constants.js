const APP_META = {
  ...
  slogan: "保护好你的猩",
  version: "MVP 0.9E",
  stage: "今日页结构压缩、页面主题色统一、日记页减重与 tabBar 顺序调整版"
};
...
const BUBBLES = [
  { source: "Gapchick", type: "粉色泡泡 · 自我关怀", tone: "care", color: "#f6a6b8", text: "今天不必把自己拧干。睡前泡个脚，让身体先下班。" },
  { source: "Gapchick", type: "粉色泡泡 · 自我关怀", tone: "care", color: "#f6a6b8", text: "先喝水，再处理人生。顺序不能乱。" },
  { source: "Gapchick", type: "粉色泡泡 · 自我关怀", tone: "care", color: "#f6a6b8", text: "你不是没用，只是电量真的低了。先别拿低电量做人生判决。" },
  ...
  { source: "Elodie", type: "绿色泡泡 · 清醒提醒", tone: "encourage", color: "#9ccf9a", text: "先把预设放远一点。发生了什么，比你该不该难受更重要。" },
  { source: "Elodie", type: "绿色泡泡 · 清醒提醒", tone: "encourage", color: "#9ccf9a", text: "不是每条路都要走到尽头，才配换方向。" },
  { source: "Elodie", type: "绿色泡泡 · 清醒提醒", tone: "encourage", color: "#9ccf9a", text: "你可以慢一点。别为了显得正常，把自己弄丢。" },
...
const EXIT_TEST_RESULTS = [
  {
    ...
    max: 20,
    title: "短期波动观察型",
    text: "你现在可能处在一段明显不舒服的阶段，但还不一定需要立刻做重大决定。先观察频率，照顾身体，把最近发生的具体事件记下来。",
  ...
  },
  {
    ...
    max: 50,
    title: "过渡计划启动型",
    text: "你已经有比较明确的离开或转向倾向。现在不要靠冲动硬跳，也不要继续无限拖延。你需要的是一个更稳一点的过渡计划。",
...
const EMERGENCY_CARDS = [
  {
    title: "我是不是很没用？",
    hold: "你不是没用。你可能只是被消耗太久，身体先把话说出来了。",
  ...
  },
  {
    ...
    reframe: "这个问题不用今天定罪。更具体的问题是：我有没有在为下一步做一点准备。",
    action: "写下：如果我不留在这里，我想把时间还给哪三件事？"
  },
  {
    title: "我今天什么都没做怎么办？",
    hold: "什么都没做的一天，也可能是在恢复电量。",
    reframe: "休息不是进度的反面。对一个被耗空的人来说，先停一下不是偷懒。",
  ...
  {
    title: "我想离职，但我很害怕怎么办？",
    hold: "害怕不是失败，它只是说明这件事真的有重量。",
    reframe: "离职不是从悬崖上跳下去。你可以先搭一座很小的桥。",
    action: "今天只做一个准备动作：算钱、改简历、问一个问题，或整理一条事实纪要。"
  }
];
...
const TRIED_ACTION_OPTIONS = ["忍了", "沟通过", "找朋友说了", "写下来了", "请假 / 休息", "保存材料", "投简历", "准备离职", "暂时不处理"];
...
const SKILL_CARDS = [
  { title: "事实纪要怎么写", content: "先写发生了什么，再写谁做了什么，最后写它影响了你哪里。评价可以晚一点来，事实先落地。" },
  ...
  { title: "怎么判断我是逃避还是转向", content: "想离开痛苦和想靠近新生活可以同时存在。先记录触发点，再看准备动作有没有慢慢出现。" },
