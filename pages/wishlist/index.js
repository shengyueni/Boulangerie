...
Page({
  data: { items: [], activeType: "pre_exit", newTitle: "", newCategory: "钱与保障", categories: PLAN_CATEGORIES.pre_exit, groups: [], total: 0, completed: 0, percent: 0, progressText: "", companion: buildCompanion("gapchick", "wishlist", { image: getGapchickVariantImage("rest"), tag: "慢慢重建", variant: "rest", size: "bust" }) },
